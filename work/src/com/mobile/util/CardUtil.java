...
public class CardUtil {
    static {
        ...
        MobileCard card1 = new MobileCard("熊大", "123", "13998765412", new TalkPackage(), 0, 0);
        MobileCard card2 = new MobileCard("熊二", "123", "13962345678", new NetPackage(), 0, 0);
        MobileCard card3 = new MobileCard("光头强", "123", "13926485946", new SuperPackage(), 0, 0);
        MobileCard card4 = new MobileCard("涂涂", "123", "13968534598", new TalkPackage(), 0, 0);
